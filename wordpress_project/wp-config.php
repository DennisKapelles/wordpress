...
define( 'DB_NAME', 'e_pix_project01' );
 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         '2uV0ld!_tEiI`+G9:$|TcE7$zE_nG{5c=Hn S=-LXqki_HQ0(k}$C>y=O]Rx1rY[' );
define( 'SECURE_AUTH_KEY',  '4_-PF24X>&ly4|d!g`69|<fGX5Ac6[_oz&HQmD_iwkuqD)16D4w;vg&Hlg1YZM|`' );
define( 'LOGGED_IN_KEY',    'HofC_(sYw2^-tO|.#u~rw6?9Pq;C3X=,8B{na%ln-o=(5_(A(%`<S$.+wh32??Y9' );
define( 'NONCE_KEY',        'yTQ_(-Pk;8~XY&DdHES:j+[1Zj?oT_2^y)1M3QVF_W0tVz6H8,6W?S^ouTc]bYkd' );
define( 'AUTH_SALT',        'S}c$P[yY(4bFT;[,xWSeIF?8J<pXzk?`/(>,}4eF|1+TC5KQn[hnkv`2Wk7S0-v6' );
define( 'SECURE_AUTH_SALT', 'UD!SAR?{te*2jV[-yEGHKAB?y%(i)#]]w;^5B*uJvo|#gtla0626VBXnF5;3Ig+y' );
define( 'LOGGED_IN_SALT',   '#d*y!?Q85UQ<yd;1){Oxwl0d2NV(h=tRsk5I [`Ap~@g>ydr-K:Y>hk9< _[jk`K' );
define( 'NONCE_SALT',       'k!>{Lw]EsE^(szt1cTV) d<3OR<~7M[Ist9(0Ipsn5 bywF@qem(zoKRKHA,}$2E' );
